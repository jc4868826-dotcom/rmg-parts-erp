          ...
          {showOcPendientes && (
            <div className="border-t" style={{ borderColor: 'rgba(45,201,138,0.15)' }}>
              <table className="w-full text-sm">
                <thead>
                  <tr style={{ background: 'rgba(15, 35, 60,0.02)', borderBottom: '1px solid rgba(56,182,255,0.06)' }}>
                ...
                <tbody>
                  {ocsPendientes.map(oc => (
                    <tr key={oc.id} style={{ borderBottom: '1px solid rgba(15, 35, 60,0.03)' }}>
              ...
              {['directa', 'oc'].map(o => (
                <button key={o} type="button" onClick={() => { setOrigenSelector(o); if (o === 'directa') setForm(f => ({ ...f, oc_id: null, origen: 'directa' })) }}
                  ...
                  style={origenSelector === o
                    ...
                    : { background: 'transparent', color: 'var(--rmg-muted)', border: '1px solid rgba(15, 35, 60,0.1)' }}>
            ...
            <tbody>
              {isLoading
                ...
                : compras.map((c, i) => {
                    ...
                    return (
                      <tr key={c.id} style={{ borderBottom: '1px solid rgba(15, 35, 60,0.04)', background: i % 2 ? 'transparent' : 'rgba(15, 35, 60,0.01)' }}
                        ...
                        <td className="px-4 py-3">
                          <div className="flex gap-1 items-center flex-wrap">
                            ...
                            <button onClick={() => setEditando({ ...c })} className="p-1.5 rounded hover:bg-black/5" style={{ color: 'var(--rmg-muted)' }} title="Editar"><Pencil size={13}/></button>
